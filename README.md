...
* 会在线程中切换逻辑设备的程序
    ...
    允许在一个线程中重建逻辑设备，但不能来回切换不同逻辑设备，这是为了在满足 “[基于线程的状态机](docs/VKEncapsulation_快速入门.md/#特性基于线程的状态机)” 的同时确保安全性并简化程序设计。
...
* [VKEncapsulation 快速入门 (文档进度4/5)](docs/VKEncapsulation_快速入门.md)
