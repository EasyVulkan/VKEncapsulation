...
#define DefineSetter_Copy(F, T, var, ...)                       constexpr _& F(T const& var) & { this->var = var; __VA_ARGS__; return *this; }                                                                         constexpr _&& F(T const& var) && { this->var = var; __VA_ARGS__; return std::move(*this); }
